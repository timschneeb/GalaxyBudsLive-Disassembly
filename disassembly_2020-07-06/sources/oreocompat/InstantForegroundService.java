...
public class InstantForegroundService extends IntentService {
    ...
    private static final String TAG = "NeoBean_InstantForegroundService";
    ...
    private void startForegroundWithNotification() {
        ...
        startForeground(R.id.notification_instant_foreground_service, new NotificationCompat.Builder(this, AppNotificationChannels.ID_NOTIFICATION_DELAYS).build());
    }
