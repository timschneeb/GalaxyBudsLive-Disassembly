...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, BundleSavedStateRegistryOwner {
    ...
    public final boolean isVisible() {
        View view;
        return isAdded() && !isHidden() && view != null && view.getWindowToken() != null && this.mView.getVisibility() == 0;
    }
    ...
    public void initState() {
        initLifecycle();
        this.mSavedStateRegistry = new BundleSavedStateRegistry();
