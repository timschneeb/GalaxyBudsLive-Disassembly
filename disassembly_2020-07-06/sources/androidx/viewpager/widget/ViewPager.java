...
import androidx.reflect.view.SeslMotionEventReflector;
...
public class ViewPager extends ViewGroup {
    ...
    private SeslEdgeEffect mLeftEdge;
    ...
    private SeslEdgeEffect mRightEdge;
    ...
    public void initViewPager() {
        ...
        this.mLeftEdge = new SeslEdgeEffect(context);
        this.mRightEdge = new SeslEdgeEffect(context);
    ...
    public void setCurrentItemFromUser(int i, boolean z) {
        this.mPopulatePending = false;
    ...
    private void scrollToItem(int i, boolean z, int i2, boolean z2) {
        ...
        if (infoForPosition != null) {
            ...
            int constrain = (int) (MathUtils.constrain(infoForPosition.offset, this.mFirstOffset, this.mLastOffset) * clientWidth);
            i3 = seslIsDatePickerLayoutRtl() ? (16777216 - ((int) ((clientWidth * infoForPosition.widthFactor) + DEFAULT_TOUCH_SLOP_RATE))) - constrain : constrain;
        } else {
            i3 = 0;
        }
        if (z) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x0073, code lost:
        if (r9.position == r0.mCurItem) goto L_0x007a;
     */
            ...
            if (count == this.mExpectedAdapterCount) {
                ...
                if (itemInfo2 != null) {
                    ...
                    if (clientWidth <= 0) {
                        ...
                        f = (((float) getPaddingLeft()) / ((float) clientWidth)) + (2.0f - itemInfo2.widthFactor);
                    }
                    int i8 = i7;
                    int i9 = i6;
                    float f3 = 0.0f;
                    for (int i10 = this.mCurItem - 1; i10 >= 0; i10--) {
                        if (f3 < f || i10 >= max) {
                            if (itemInfo4 == null || i10 != itemInfo4.position) {
                                f3 += addNewItem(i10, i8 + 1).widthFactor;
                                i9++;
                                if (i8 >= 0) {
                ...
                if (hasFocus()) {
                    ...
                    if (infoForAnyChild == null || infoForAnyChild.position != this.mCurItem) {
                        ...
                        while (i14 < getChildCount()) {
                            ...
                            if (infoForChild2 == null || infoForChild2.position != this.mCurItem || !childAt2.requestFocus(i4)) {
                                i14++;
                            } else {
                                return;
                            }
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i13 = 0; i13 < childCount2; i13++) {
            ...
            if (childAt2.getVisibility() != 8 && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.isDecor)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) i7) * layoutParams.widthFactor), 1073741824), makeMeasureSpec);
            }
        }
    }
    ...
    private void recomputeScrollPosition(int i, int i2, int i3, int i4) {
        if (i2 <= 0 || this.mItems.isEmpty()) {
            ...
            float seslGetScrollStart = ((float) seslGetScrollStart()) / ((float) (((i2 - getPaddingLeft()) - getPaddingRight()) + i4));
            scrollTo(seslIsDatePickerLayoutRtl() ? (int) (1.6777216E7f - (seslGetScrollStart * ((float) paddingLeft))) : (int) (seslGetScrollStart * ((float) paddingLeft)), getScrollY());
        }
    }
        ...
        for (int i18 = 0; i18 < childCount; i18++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (infoForChild = infoForChild(childAt2)) != null) {
                    float f = (float) i17;
                    int i19 = (int) (infoForChild.offset * f);
                    int measuredWidth = seslIsDatePickerLayoutRtl() ? ((16777216 - paddingRight) - i19) - childAt2.getMeasuredWidth() : i12 + i19;
                    ...
                    childAt2.layout(measuredWidth, i11, childAt2.getMeasuredWidth() + measuredWidth, childAt2.getMeasuredHeight() + i11);
                }
            }
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (this.mUsePagingTouchSlopForStylus) {
                if (motionEvent2.isFromSource(InputDeviceCompat.SOURCE_STYLUS)) {
            ...
            if (i != -1) {
                ...
                if (abs > ((float) this.mTouchSlop) && abs * this.mTouchSlopRatio > abs2) {
                    this.mIsBeingDragged = true;
                    requestParentDisallowInterceptTouchEvent(true);
                    setScrollState(1);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (action == 2) {
                ...
                if (this.mIsBeingDragged) {
                    try {
                        ...
                        Log.e(TAG, "ACTION_MOVE, catch IllegalArgumentException, mActivePointerId = " + this.mActivePointerId);
                        Log.e(TAG, "ev.findPointerIndex() = " + motionEvent.findPointerIndex(this.mActivePointerId));
                        Log.e(TAG, "ev.getPointerCount() = " + motionEvent.getPointerCount());
                        Log.e(TAG, "ev.getPointerIdBits() = " + Integer.toBinaryString(SeslMotionEventReflector.getPointerIdBits(motionEvent)));
                        throw e;
                    }
                }
            } else if (action != 3) {
                if (action == 5) {
                    ...
                    try {
                        ...
                        Log.e(TAG, "ACTION_POINTER_DOWN, catch IllegalArgumentException, mActivePointerId = " + this.mActivePointerId);
                        Log.e(TAG, "index = " + actionIndex);
                        Log.e(TAG, "ev.getPointerCount() = " + motionEvent.getPointerCount());
                        Log.e(TAG, "ev.getPointerIdBits() = " + Integer.toBinaryString(SeslMotionEventReflector.getPointerIdBits(motionEvent)));
                        throw e2;
                    }
                    ...
                    try {
                        ...
                        Log.e(TAG, "ACTION_POINTER_UP, catch IllegalArgumentException, mActivePointerId = " + this.mActivePointerId);
                        Log.e(TAG, "ev.findPointerIndex = " + motionEvent.findPointerIndex(this.mActivePointerId));
                        Log.e(TAG, "ev.getPointerCount() = " + motionEvent.getPointerCount());
                        Log.e(TAG, "ev.getPointerIdBits() = " + Integer.toBinaryString(SeslMotionEventReflector.getPointerIdBits(motionEvent)));
                        throw e3;
            ...
            float clientWidth = (float) getClientWidth();
            float seslGetScrollStart = ((float) seslGetScrollStart()) / clientWidth;
            ItemInfo infoForCurrentScrollPosition = infoForCurrentScrollPosition();
            float f3 = ((float) this.mPageMargin) / clientWidth;
            int i = infoForCurrentScrollPosition.position;
            if (seslIsDatePickerLayoutRtl()) {
                f = (infoForCurrentScrollPosition.offset - seslGetScrollStart) / (infoForCurrentScrollPosition.widthFactor + f3);
            } else {
                f = (seslGetScrollStart - infoForCurrentScrollPosition.offset) / (infoForCurrentScrollPosition.widthFactor + f3);
            }
    ...
    private boolean performDrag(float f) {
        SeslEdgeEffect seslEdgeEffect;
        SeslEdgeEffect seslEdgeEffect2;
        float f2;
        boolean z;
        float f3;
        float f4;
        ...
        if (seslIsDatePickerLayoutRtl()) {
            seslEdgeEffect2 = this.mRightEdge;
            seslEdgeEffect = this.mLeftEdge;
        } else {
            seslEdgeEffect2 = this.mLeftEdge;
            seslEdgeEffect = this.mRightEdge;
        }
        ...
        if (!z3) {
            f7 = itemInfo.offset;
            f6 = (float) clientWidth;
        } else if (seslIsDatePickerLayoutRtl()) {
            float f9 = (float) clientWidth;
            f2 = (this.mFirstOffset * f9) + f9;
            ArrayList<ItemInfo> arrayList = this.mItems;
            ItemInfo itemInfo2 = arrayList.get(arrayList.size() - 1);
            z = itemInfo2.position != this.mAdapter.getCount() - 1;
            if (z) {
                f5 = itemInfo2.offset;
                f4 = (float) clientWidth;
            } else if (seslIsDatePickerLayoutRtl()) {
                float f10 = (float) clientWidth;
                f3 = (this.mLastOffset * f10) + f10;
                if (scrollX < f2) {
                    if (z3) {
                        seslEdgeEffect2.onPull(Math.abs(f2 - scrollX) / ((float) clientWidth));
                        z2 = true;
                    }
                    scrollX = f2;
                } else if (scrollX > f3) {
                    if (z) {
                        seslEdgeEffect.onPull(Math.abs(scrollX - f3) / ((float) clientWidth));
                        z2 = true;
                    }
                    scrollX = f3;
                }
            ...
            f7 = (float) clientWidth;
            f6 = this.mFirstOffset;
        }
        f2 = f7 * f6;
        ArrayList<ItemInfo> arrayList2 = this.mItems;
        ItemInfo itemInfo22 = arrayList2.get(arrayList2.size() - 1);
        if (itemInfo22.position != this.mAdapter.getCount() - 1) {
        }
        if (z) {
        }
        f3 = f5 * f4;
        ...
        int i22 = (int) scrollX;
        this.mLastMotionX += scrollX - ((float) i22);
        scrollTo(i22, getScrollY());
        pageScrolled(i22);
        return z2;
    }
    ...
    private ItemInfo infoForCurrentScrollPosition() {
        int i;
        int seslGetScrollStart = seslGetScrollStart();
        int clientWidth = getClientWidth();
        float f = clientWidth > 0 ? ((float) seslGetScrollStart) / ((float) clientWidth) : 0.0f;
    ...
    private int determineTargetPage(int i, float f, int i2, int i3) {
        ...
        ArrayList<ItemInfo> arrayList = this.mItems;
        return MathUtils.constrain(i4, this.mItems.get(0).position, arrayList.get(arrayList.size() - 1).position);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (overScrollMode == 0 || (overScrollMode == 1 && (pagerAdapter = this.mAdapter) != null && pagerAdapter.getCount() > 1)) {
            if (!this.mLeftEdge.isFinished()) {
                ...
                if (seslIsDatePickerLayoutRtl()) {
                    canvas.translate((float) ((-height) + getPaddingTop()), ((-(this.mLastOffset + 1.0f)) * ((float) width)) + 1.6777216E7f);
                } else {
        ...
        if (this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
            ...
            while (i2 < i3) {
                ...
                if (i2 == itemInfo.position) {
                    ...
                    f = seslIsDatePickerLayoutRtl() ? 1.6777216E7f - f5 : (f5 + pageWidth) * f3;
                    f5 += pageWidth + f4;
                }
    ...
    public void seslSetTouchSlop(int i) {
    ...
    public void seslSetTouchSlopRatio(float f) {
    ...
    public void seslCanSupportLayoutDirectionForDatePicker(boolean z) {
        this.mSupportLayoutDirectionForDatePicker = z;
    }

    private boolean seslIsDatePickerLayoutRtl() {
        return this.mSupportLayoutDirectionForDatePicker && getLayoutDirection() == 1;
    }

    private int seslGetScrollStart() {
        if (seslIsDatePickerLayoutRtl()) {
