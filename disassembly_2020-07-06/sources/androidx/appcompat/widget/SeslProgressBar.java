...
public class SeslProgressBar extends View {
    ...
    public SeslProgressBar(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        setMin(obtainStyledAttributes.getInt(R.styleable.ProgressBar_min, this.mMin));
        ...
        this.mOnlyIndeterminate = obtainStyledAttributes.getBoolean(R.styleable.ProgressBar_android_indeterminateOnly, this.mOnlyIndeterminate);
        this.mNoInvalidate = false;
        setIndeterminate((this.mOnlyIndeterminate || obtainStyledAttributes.getBoolean(R.styleable.ProgressBar_android_indeterminate, this.mIndeterminate)) ? true : z);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ProgressBar_android_progressTintMode)) {
            ...
            this.mProgressTintInfo.mProgressTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(R.styleable.ProgressBar_android_progressTintMode, -1), (PorterDuff.Mode) null);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ProgressBar_android_progressBackgroundTintMode)) {
            ...
            this.mProgressTintInfo.mProgressBackgroundTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(R.styleable.ProgressBar_android_progressBackgroundTintMode, -1), (PorterDuff.Mode) null);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ProgressBar_android_secondaryProgressTintMode)) {
            ...
            this.mProgressTintInfo.mSecondaryProgressTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(R.styleable.ProgressBar_android_secondaryProgressTintMode, -1), (PorterDuff.Mode) null);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ProgressBar_android_indeterminateTintMode)) {
            ...
            this.mProgressTintInfo.mIndeterminateTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(R.styleable.ProgressBar_android_indeterminateTintMode, -1), (PorterDuff.Mode) null);
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r8v1, resolved type: android.graphics.drawable.BitmapDrawable} */
    ...
    private Drawable tileify(Drawable drawable, boolean z) {
        ...
        if (drawable instanceof LayerDrawable) {
            ...
            if (z2) {
                bitmapDrawable = (BitmapDrawable) drawable.getConstantState().newDrawable(getResources());
    ...
    public synchronized void doRefreshProgress(int i, int i2, boolean z, boolean z2, boolean z3) {
        ...
        synchronized (this) {
            ...
            float f = i5 > 0 ? ((float) (i4 - this.mMin)) / ((float) i5) : 0.0f;
            boolean z4 = i3 == R.id.progress;
            ...
            if (drawable2 == null) {
                ...
                int StateListDrawable_getStateCount = StateListDrawable_getStateCount((StateListDrawable) drawable2);
                int i7 = 0;
                while (i7 < StateListDrawable_getStateCount) {
                    Drawable StateListDrawable_getStateDrawable = StateListDrawable_getStateDrawable((StateListDrawable) drawable2, i7);
                    if (StateListDrawable_getStateDrawable != null) {
                        if (StateListDrawable_getStateDrawable instanceof LayerDrawable) {
                            drawable = ((LayerDrawable) StateListDrawable_getStateDrawable).findDrawableByLayerId(i);
            ...
            if (this.mOnlyIndeterminate && !(drawable instanceof AnimationDrawable)) {
                ...
                if (((double) Math.abs(intrinsicWidth - f3)) < 1.0E-7d) {
                    if (f3 > intrinsicWidth) {
                        ...
                        this.mIndeterminateDrawable.setBounds(i6, i3, paddingRight, paddingTop);
                    } else {
