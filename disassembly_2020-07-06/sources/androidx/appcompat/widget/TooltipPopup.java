...
class TooltipPopup {
    ...
    private void computePosition(View view, int i, int i2, boolean z, WindowManager.LayoutParams layoutParams, boolean z2, boolean z3) {
        ...
        layoutParams2.x = (iArr2[0] + width) - (this.mTmpDisplayFrame.width() / 2);
        ...
        if (z) {
            if (view.getLayoutDirection() == 0) {
                ...
                layoutParams2.x = (((this.mTmpAnchorPos[0] + view.getWidth()) - (this.mTmpDisplayFrame.width() / 2)) - i5) - dimensionPixelOffset;
                if (layoutParams2.x < ((-this.mTmpDisplayFrame.width()) / 2) + i5) {
                    layoutParams2.x = ((-this.mTmpDisplayFrame.width()) / 2) + i5 + dimensionPixelOffset;
                }
                layoutParams2.x = AdjustTooltipPosition(view2, layoutParams2.x, measuredWidth, dimensionPixelOffset);
            } else {
                layoutParams2.x = ((this.mTmpAnchorPos[0] + width) - (this.mTmpDisplayFrame.width() / 2)) + (measuredWidth / 2) + dimensionPixelOffset;
                layoutParams2.x = AdjustTooltipPosition(view2, layoutParams2.x, measuredWidth, dimensionPixelOffset);
            }
            ...
            layoutParams2.x = (this.mTmpAnchorPos[0] + width) - (this.mTmpDisplayFrame.width() / 2);
            int i6 = measuredWidth / 2;
            if (layoutParams2.x < ((-this.mTmpDisplayFrame.width()) / 2) + i6) {
                layoutParams2.x = ((-this.mTmpDisplayFrame.width()) / 2) + i6 + dimensionPixelOffset2;
            }
            layoutParams2.x = AdjustTooltipPosition(view2, layoutParams2.x, measuredWidth, dimensionPixelOffset);
            if (i4 >= 0) {
                layoutParams2.y = i4;
        ...
        if (z2) {
            layoutParams2.y = this.mTmpAnchorPos[1] + view.getHeight();
        }
        if (z3) {
            if (view.getLayoutDirection() == 0) {
                int i7 = measuredWidth / 2;
                layoutParams2.x = (((this.mTmpAnchorPos[0] + view.getWidth()) - (this.mTmpDisplayFrame.width() / 2)) - i7) - dimensionPixelOffset;
                if (layoutParams2.x < ((-this.mTmpDisplayFrame.width()) / 2) + i7) {
                    layoutParams2.x = ((-this.mTmpDisplayFrame.width()) / 2) + i7 + dimensionPixelOffset2;
                }
                layoutParams2.x = AdjustTooltipPosition(view2, layoutParams2.x, measuredWidth, dimensionPixelOffset);
            } else {
                layoutParams2.x = (((this.mTmpAnchorPos[0] + width) - (this.mTmpDisplayFrame.width() / 2)) + (measuredWidth / 2)) - dimensionPixelOffset;
    ...
    private int AdjustTooltipPosition(View view, int i, int i2, int i3) {
        int i4;
