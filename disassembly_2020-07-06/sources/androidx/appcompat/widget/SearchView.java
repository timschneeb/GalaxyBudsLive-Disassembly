...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private static final String SESL_AUTHORITY_SVI_APP = "com.samsung.android.svoiceime.provider";
    private static final String SESL_KEY_SVI_APP_LOCALE = "is_svoice_locale_supported";
    private static final int SESL_SEP_VERSION_SUPPORTING_SVI_SEARCH_QUERY = 110100;
    private static final String SESL_SVI_ACTION = "samsung.svoiceime.action.RECOGNIZE_SPEECH";
    private static final String SESL_SVI_INTENT_EXTRA = "samsung.svoiceime.extra.LANGUAGE";
    private static final String SESL_SVI_PACKAGE = "com.samsung.android.svoiceime";
    private static final int SESL_SVI_VERSION_SUPPORTING_SEARCH_QUERY = 220002001;
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(R.styleable.SearchView_layout, R.layout.sesl_search_view), this, true);
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            ImageView imageView7 = this.mSearchButton;
            TooltipCompat.setTooltipText(imageView7, imageView7.getContentDescription());
            ImageView imageView8 = this.mCloseButton;
            TooltipCompat.setTooltipText(imageView8, imageView8.getContentDescription());
            ImageView imageView9 = this.mGoButton;
            TooltipCompat.setTooltipText(imageView9, imageView9.getContentDescription());
            ImageView imageView10 = this.mVoiceButton;
            TooltipCompat.setTooltipText(imageView10, imageView10.getContentDescription());
            ImageView imageView11 = this.mMoreButton;
            TooltipCompat.setTooltipText(imageView11, imageView11.getContentDescription());
            ImageView imageView12 = this.mBackButton;
            TooltipCompat.setTooltipText(imageView12, imageView12.getContentDescription());
        ...
        this.mSVoiceSearchIntent = new Intent(SESL_SVI_ACTION);
        this.mSVoiceSearchIntent.addFlags(268435456);
        this.mSVoiceSearchIntent.putExtra(SESL_SVI_INTENT_EXTRA, Locale.getDefault().toString());
    ...
    private void updateCloseButton() {
        ...
        if (!z && this.mIconifiedByDefault) {
            boolean z2 = this.mExpandedInActionView;
        }
        ...
        if (searchableInfo != null) {
            try {
                if (!this.mUseSVI) {
                    ...
                    getContext().startActivity(createSVoiceSearchIntent(this.mSVoiceSearchIntent, searchableInfo));
                }
    ...
    public boolean seslSetSviEnabled(boolean z) {
        if (SeslBuildReflector.SeslVersionReflector.getField_SEM_PLATFORM_INT() < SESL_SEP_VERSION_SUPPORTING_SVI_SEARCH_QUERY) {
        ...
        if (this.mUseSVI) {
            try {
                PackageInfo packageInfo = getContext().getPackageManager().getPackageInfo(SESL_SVI_PACKAGE, 0);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0044, code lost:
        throw r4;
     */
    /* JADX WARNING: Exception block dominator not found, dom blocks: [B:13:0x0031, B:21:0x003c] */
    /* JADX WARNING: Removed duplicated region for block: B:32:0x0060 A[ORIG_RETURN, RETURN, SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:34:? A[RETURN, SYNTHETIC] */
    private boolean isSystemLocaleSupported() {
        int i;
        try {
            Cursor query = this.mContext.getContentResolver().query(Uri.parse("content://com.samsung.android.svoiceime.provider/is_svoice_locale_supported"), (String[]) null, (String) null, (String[]) null, (String) null);
            if (query == null) {
                if (query != null) {
                    query.close();
                }
            ...
            while (query.moveToNext()) {
                i = query.getInt(query.getColumnIndex(SESL_KEY_SVI_APP_LOCALE));
            }
            if (query != null) {
                query.close();
            }
    ...
    public void seslSetNotCallShowSoftInput(boolean z) {
        this.mSearchSrcTextView.seslSetNotCallShowSoftInput(z);
    }
}
