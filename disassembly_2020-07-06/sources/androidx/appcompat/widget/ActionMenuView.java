...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    public ActionMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.mPopupTheme = 0;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.View, R.attr.actionButtonStyle, 0);
        this.mOriginalStartPadding = obtainStyledAttributes.getDimensionPixelSize(R.styleable.View_paddingStart, 0);
        this.mOriginalEndPadding = obtainStyledAttributes.getDimensionPixelSize(R.styleable.View_paddingEnd, 0);
        obtainStyledAttributes.recycle();
        TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, R.styleable.View, R.attr.actionOverflowButtonStyle, 0);
        this.mOriginalOverflowStartPadding = obtainStyledAttributes2.getDimensionPixelSize(R.styleable.View_paddingStart, 0);
        this.mOriginalOverflowEndPadding = obtainStyledAttributes2.getDimensionPixelSize(R.styleable.View_paddingEnd, 0);
        this.mOverflowButtonMinWidth = obtainStyledAttributes2.getDimensionPixelSize(R.styleable.View_android_minWidth, 0);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes((AttributeSet) null, R.styleable.View, R.attr.actionButtonStyle, 0);
        this.mOriginalStartPadding = obtainStyledAttributes.getDimensionPixelSize(R.styleable.View_paddingStart, 0);
        this.mOriginalEndPadding = obtainStyledAttributes.getDimensionPixelSize(R.styleable.View_paddingEnd, 0);
        obtainStyledAttributes.recycle();
        TypedArray obtainStyledAttributes2 = getContext().obtainStyledAttributes((AttributeSet) null, R.styleable.View, R.attr.actionOverflowButtonStyle, 0);
        this.mOriginalOverflowStartPadding = obtainStyledAttributes2.getDimensionPixelSize(R.styleable.View_paddingStart, 0);
        this.mOriginalOverflowEndPadding = obtainStyledAttributes2.getDimensionPixelSize(R.styleable.View_paddingEnd, 0);
        this.mOverflowButtonMinWidth = obtainStyledAttributes2.getDimensionPixelSize(R.styleable.View_android_minWidth, 0);
        obtainStyledAttributes2.recycle();
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (childAt instanceof ActionMenuItemView) {
                    ...
                    if (childAt instanceof ActionMenuPresenter.OverflowMenuButton) {
                        ...
                        viewGroup.getChildAt(0).setPaddingRelative(this.mOriginalOverflowStartPadding, 0, this.mOriginalOverflowEndPadding, 0);
