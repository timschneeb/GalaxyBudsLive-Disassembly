...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    boolean mIsFloating;
    boolean mIsIgnoreRemoveSystemTopInset = false;
    ...
    private ViewGroup createSubDecor() {
        ...
        if (!obtainStyledAttributes.hasValue(R.styleable.AppCompatTheme_windowActionBar)) {
            obtainStyledAttributes.recycle();
            String[] theme = SeslContextReflector.getTheme(this.mContext);
            if (theme != null) {
                for (int i = 0; i < theme.length; i++) {
                    Log.e("AppCompatDelegate", "getTheme = strTheme[" + i + "] = " + theme[i]);
                }
            }
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.AppCompatTheme_ignoreRemoveSystemTopInset)) {
            this.mIsIgnoreRemoveSystemTopInset = obtainStyledAttributes.getBoolean(R.styleable.AppCompatTheme_ignoreRemoveSystemTopInset, false);
        }
        obtainStyledAttributes.recycle();
        this.mWindow.getDecorView();
        LayoutInflater from = LayoutInflater.from(this.mContext);
        if (this.mWindowNoTitle) {
            viewGroup = (ViewGroup) from.inflate(this.mOverlayActionMode ? R.layout.sesl_screen_simple_overlay_action_mode : R.layout.sesl_screen_simple, (ViewGroup) null);
            ...
            if (actionMode == null) {
                ...
                if (this.mActionModeView == null) {
                    if (this.mIsFloating) {
                        ...
                        View findViewById = this.mSubDecor.findViewById(this.mSubDecor.getContext().getResources().getIdentifier("collapsing_toolbar", GroupMemberContract.GroupMember.ID, this.mSubDecor.getContext().getPackageName()));
                        if (findViewById == null) {
                            viewStubCompat = (ViewStubCompat) this.mSubDecor.findViewById(R.id.action_mode_bar_stub);
                        } else if (this.mOverlayActionMode) {
                            viewStubCompat = (ViewStubCompat) this.mSubDecor.findViewById(R.id.action_mode_bar_stub);
                        } else {
                            viewStubCompat = (ViewStubCompat) findViewById.findViewById(R.id.action_mode_bar_stub);
                        }
    ...
    public final boolean shouldAnimateActionModeView() {
        ViewGroup viewGroup;
        return this.mSubDecorInstalled && viewGroup != null && ViewCompat.isLaidOut(viewGroup);
    }
    ...
    public void closePanel(PanelFeatureState panelFeatureState, boolean z) {
        ...
        if (!z || panelFeatureState.featureId != 0 || (decorContentParent = this.mDecorContentParent) == null || !decorContentParent.isOverflowMenuShowing()) {
            ...
            if (!(windowManager == null || !panelFeatureState.isOpen || panelFeatureState.decorView == null)) {
                if (Build.VERSION.SDK_INT < 19 || panelFeatureState.decorView.isAttachedToWindow()) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (view == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(R.color.sesl_input_method_navigation_guard));
    ...
    protected static final class PanelFeatureState {
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, R.layout.sesl_list_menu_item_layout);
