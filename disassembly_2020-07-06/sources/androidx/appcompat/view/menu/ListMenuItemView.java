...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public void onFinishInflate() {
        ...
        if (this.mDropDownItemTextView != null) {
    ...
    private void setBadgeText(String str) {
        ...
        if (isNumericValue(str)) {
            ...
            String format = this.mNumberFormat.format((long) parseInt);
            this.mBadgeView.setText(format);
            int dimension = (int) (getResources().getDimension(R.dimen.sesl_badge_default_width) + (((float) format.length()) * getResources().getDimension(R.dimen.sesl_badge_additional_width)));
    ...
    private void insertBadge() {
        this.mBadgeView = (TextView) getInflater().inflate(R.layout.sesl_list_menu_item_badge, this, false);
