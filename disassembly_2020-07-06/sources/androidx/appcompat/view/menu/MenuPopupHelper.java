...
public class MenuPopupHelper implements MenuHelper {
    ...
    /* JADX WARNING: type inference failed for: r2v4, types: [androidx.appcompat.view.menu.CascadingMenuPopup] */
    ...
    private MenuPopup createPopup() {
        ...
        boolean z = Math.min(point.x, point.y) >= this.mContext.getResources().getDimensionPixelSize(R.dimen.abc_cascading_menus_min_smallest_width);
        boolean z2 = this.mContext.getResources().getBoolean(R.bool.sesl_config_desktop_mode);
        if (!z || z2) {
            r0 = new StandardMenuPopup(this.mContext, this.mMenu, this.mAnchorView, this.mPopupStyleAttr, this.mPopupStyleRes, this.mOverflowOnly);
        } else {
            r0 = new CascadingMenuPopup(this.mContext, this.mAnchorView, this.mPopupStyleAttr, this.mPopupStyleRes, this.mOverflowOnly);
        }
