...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    private long mAddDuration = 330;
    private long mAddStartDelay = 100;
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z4) {
                ...
                if (z || z2 || z3) {
                    ...
                    ViewCompat.postOnAnimationDelayed(((RecyclerView.ViewHolder) arrayList3.get(0)).itemView, r5, this.mAddStartDelay);
                    return;
                }
                r5.run();
            }
        ...
        animate.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                if ((DefaultItemAnimator.this.mPendingAnimFlag & 1) != 0) {
                    ...
                    int unused = defaultItemAnimator.mPendingAnimFlag = defaultItemAnimator.mPendingAnimFlag & -2;
                }
            }
        }).start();
    }
        ...
        animate.alpha(1.0f).setDuration(getAddDuration()).setListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                if ((DefaultItemAnimator.this.mPendingAnimFlag & 8) != 0) {
                    DefaultItemAnimator defaultItemAnimator = DefaultItemAnimator.this;
                    int unused = defaultItemAnimator.mPendingAnimFlag = defaultItemAnimator.mPendingAnimFlag & -9;
                }
                if ((DefaultItemAnimator.this.mPendingAnimFlag & 16) != 0) {
                    DefaultItemAnimator defaultItemAnimator2 = DefaultItemAnimator.this;
                    int unused2 = defaultItemAnimator2.mPendingAnimFlag = defaultItemAnimator2.mPendingAnimFlag & -17;
                }
            }
        }).start();
    }
    ...
    public void animateMoveImpl(RecyclerView.ViewHolder viewHolder, int i, int i2, int i3, int i4) {
        ...
        animate.setDuration(getMoveDuration()).setInterpolator(this.mMoveInterpolator).setListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                if ((DefaultItemAnimator.this.mPendingAnimFlag & 2) != 0) {
                    DefaultItemAnimator defaultItemAnimator = DefaultItemAnimator.this;
                    int unused = defaultItemAnimator.mPendingAnimFlag = defaultItemAnimator.mPendingAnimFlag & -3;
                }
                if ((DefaultItemAnimator.this.mPendingAnimFlag & 8) != 0) {
                    DefaultItemAnimator defaultItemAnimator2 = DefaultItemAnimator.this;
                    int unused2 = defaultItemAnimator2.mPendingAnimFlag = defaultItemAnimator2.mPendingAnimFlag | 16;
                }
            }
        }).start();
    }
            ...
            duration.alpha(0.0f).setListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    if ((DefaultItemAnimator.this.mPendingAnimFlag & 4) != 0) {
                        DefaultItemAnimator defaultItemAnimator = DefaultItemAnimator.this;
                        int unused = defaultItemAnimator.mPendingAnimFlag = defaultItemAnimator.mPendingAnimFlag & -5;
                    }
                }
            }).start();
        }
