...
public class SeslContextReflector {
    ...
    public static Context createPackageContextAsUser(Context context, String str, int i, UserHandle userHandle) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            method = SeslBaseReflector.getDeclaredMethod(mClass, "hidden_createPackageContextAsUser", (Class<?>[]) new Class[]{String.class, Integer.TYPE, UserHandle.class});
        } else {
            method = SeslBaseReflector.getMethod(mClass, "createPackageContextAsUser", (Class<?>[]) new Class[]{String.class, Integer.TYPE, UserHandle.class});
        }
        if (method == null) {
            return null;
        }
