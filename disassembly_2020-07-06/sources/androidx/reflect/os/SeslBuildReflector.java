...
public class SeslBuildReflector {
    ...
    public static class SeslVersionReflector {
        ...
        public static int getField_SEM_PLATFORM_INT() {
            Field declaredField;
            if (Build.VERSION.SDK_INT < 28 || (declaredField = SeslBaseReflector.getDeclaredField(mClass, "SEM_PLATFORM_INT")) == null || !(SeslBaseReflector.get((Object) null, declaredField) instanceof Integer)) {
                return -1;
            }
