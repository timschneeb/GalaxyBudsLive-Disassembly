...
public class SeslUserHandleReflector {
    ...
    public static int myUserId() {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            method = SeslBaseReflector.getDeclaredMethod(mClass, "hidden_myUserId", (Class<?>[]) new Class[0]);
        } else {
            method = SeslBaseReflector.getMethod(mClass, "myUserId", (Class<?>[]) new Class[0]);
        }
        if (method != null) {
