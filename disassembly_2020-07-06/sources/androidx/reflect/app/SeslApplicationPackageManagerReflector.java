...
public class SeslApplicationPackageManagerReflector {
    ...
    public static Drawable semGetApplicationIconForIconTray(Object obj, String str, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            method = SeslBaseReflector.getDeclaredMethod(mClassName, "hidden_semGetApplicationIconForIconTray", (Class<?>[]) new Class[]{String.class, Integer.TYPE});
        } else if (Build.VERSION.SDK_INT >= 24) {
            method = SeslBaseReflector.getMethod(mClassName, "semGetApplicationIconForIconTray", (Class<?>[]) new Class[]{String.class, Integer.TYPE});
        } else {
            method = null;
        }
        if (method != null) {
