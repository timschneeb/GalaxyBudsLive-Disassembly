...
public class SeslStateListDrawableReflector {
    ...
    public static int getStateCount(StateListDrawable stateListDrawable) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            method = SeslBaseReflector.getDeclaredMethod(mClass, "hidden_getStateCount", (Class<?>[]) new Class[0]);
        } else {
            method = SeslBaseReflector.getMethod(mClass, "getStateCount", (Class<?>[]) new Class[0]);
        }
        if (method != null) {
    ...
    public static Drawable getStateDrawable(StateListDrawable stateListDrawable, int i) {
        Method method;
        if (Build.VERSION.SDK_INT >= 29) {
            method = SeslBaseReflector.getDeclaredMethod(mClass, "hidden_getStateDrawable", (Class<?>[]) new Class[]{Integer.TYPE});
        } else {
            method = SeslBaseReflector.getMethod(mClass, "getStateDrawable", (Class<?>[]) new Class[]{Integer.TYPE});
        }
        if (method == null) {
            return null;
        }
    ...
    public static int[] getStateSet(StateListDrawable stateListDrawable, int i) {
        Method method;
        if (Build.VERSION.SDK_INT >= 29) {
            method = SeslBaseReflector.getDeclaredMethod(mClass, "hidden_getStateSet", (Class<?>[]) new Class[]{Integer.TYPE});
        } else {
            method = SeslBaseReflector.getMethod(mClass, "getStateSet", (Class<?>[]) new Class[]{Integer.TYPE});
        }
        if (method != null) {
            Object invoke = SeslBaseReflector.invoke(stateListDrawable, method, Integer.valueOf(i));
