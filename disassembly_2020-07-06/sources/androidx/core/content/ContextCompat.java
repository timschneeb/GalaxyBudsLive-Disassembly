...
public class ContextCompat {
    ...
    private static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            SERVICES.put(AccountManager.class, XDBInterface.XDM_SQL_DB_ACCXLISTNODE_ACCOUNT);
            ...
            SERVICES.put(StorageManager.class, DiagMonUtil.STORAGE);
            SERVICES.put(TelephonyManager.class, XDMInterface.XDM_DEVDETAIL_DEFAULT_DEVTYPE);
            SERVICES.put(TextServicesManager.class, "textservices");
            SERVICES.put(UiModeManager.class, XDBInterface.XDM_SQL_DB_FUMO_UIMODE);
