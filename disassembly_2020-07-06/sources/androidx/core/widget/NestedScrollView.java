...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                if (findPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (z) {
                            ...
                            SeslEdgeEffect seslEdgeEffect = this.mEdgeGlowTop;
                ...
                try {
                    ...
                    Log.e(TAG, "ev.findPointerIndex = " + motionEvent2.findPointerIndex(this.mActivePointerId));
        ...
        if ((motionEvent.getSource() & 2) != 0 && motionEvent.getAction() == 8 && !this.mIsBeingDragged) {
            ...
            if (axisValue != 0.0f) {
                ...
                if (verticalScrollFactorCompat != scrollY) {
                    startNestedScroll(verticalScrollFactorCompat, 1);
                    if (!dispatchNestedPreScroll(0, verticalScrollFactorCompat, (int[]) null, (int[]) null, 1)) {
    ...
    private void ensureGlows() {
        if (getOverScrollMode() == 2) {
            ...
            Context context = getContext();
            this.mEdgeGlowTop = new SeslEdgeEffect(context);
            this.mEdgeGlowBottom = new SeslEdgeEffect(context);
