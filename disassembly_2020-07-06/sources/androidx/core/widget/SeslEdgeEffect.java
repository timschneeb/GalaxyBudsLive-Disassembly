...
public class SeslEdgeEffect extends EdgeEffect {
    ...
    private Runnable mForceCallOnRelease = new Runnable() {
        public void run() {
            boolean unused = SeslEdgeEffect.this.mOnReleaseCalled = true;
    ...
    public void setSeslHostView(View view) {
        this.mSeslHostView = view;
    }
    ...
    public void onPull(float f, float f2) {
        ...
        if (this.mState != 4 || ((float) (currentAnimationTimeMillis - this.mStartTime)) >= this.mDuration) {
            ...
            if (this.mPullDistance == 0.0f || this.mOnReleaseCalled) {
                if (!(this.mSeslHostView == null || (semGetVibrationIndex = SeslHapticFeedbackConstantsReflector.semGetVibrationIndex(28)) == -1)) {
                    this.mSeslHostView.performHapticFeedback(semGetVibrationIndex);
                }
                this.mState = 1;
