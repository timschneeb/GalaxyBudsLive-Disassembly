...
public class XDMHandleCmd implements XDMInterface {
    ...
    public void xdmAgentHdlCmdAtomicEnd(Object obj) {
        XDMWorkspace xDMWorkspace = (XDMWorkspace) obj;
        if (xDMWorkspace.inAtomicCmd || xDMWorkspace.inSequenceCmd) {
            xdmAgentHdlCmdLocateSelectedAgent((XDMAgent) null, xDMWorkspace.list);
    ...
    private static XDMList xdmAgentDataStDuplItemlist(XDMList xDMList) {
        ...
        while (xDMList != null) {
            ...
            if (xDMList2 == null) {
                xDMList2 = XDMList.xdmListAppend(xDMList2, (XDMList) null, xDMParserItem);
            } else {
                XDMList.xdmListAppend(xDMList2, (XDMList) null, xDMParserItem);
            }
            xDMList = xDMList3;
        }
        return xDMList2;
