...
public class XDMTask implements Runnable, XDMDefInterface, XDMInterface, XEventInterface, XCommonInterface, XUICInterface, XFOTAInterface, XNOTIInterface, XTPInterface {
    ...
    private static void xdmTaskRemoveMessage() {
        g_hDmTask.removeMessages(0, (Object) null);
    }
    ...
    private void xdmAgentTaskHandler(Message message) throws InterruptedException {
        ...
        if (message2.obj != null) {
            XDMMsg.XDMMsgItem xDMMsgItem = (XDMMsg.XDMMsgItem) message2.obj;
            XEventInterface.XEVENT valueOf = XEventInterface.XEVENT.valueOf(message2.what);
            ...
            switch (valueOf) {
                case XEVENT_DM_CONNECT:
                    if (XDMInitExecutor.getInstance().isDmInitializedSuccessfully()) {
                        ...
                        if (xfotaDlAgentIsStatus) {
                            ...
                            XDMMsg.xdmSendMessage(XEventInterface.XEVENT.XEVENT_DM_TCPIP_OPEN, (Object) null, (Object) null);
                            return;
                        }
                        ...
                        if (xdbGetFUMOUpdateMechanism == 2) {
                            if (xdbGetFUMOStatus2 == 50 || xdbGetFUMOStatus2 == 251) {
                                ...
                                XDMEvent.XDMSetEvent((Object) null, XUIEventInterface.DL_UIEVENT.XUI_DL_DOWNLOAD_YES_NO);
                                return;
                            } else {
                        ...
                        XDMEvent.XDMSetEvent((Object) null, XUIEventInterface.DM_UIEVENT.XUI_DM_NOT_INIT);
                        return;
                    }
                ...
                case XEVENT_DM_ABORT:
                    ...
                    if (i3 != 249) {
                        switch (i3) {
                            case 241:
                                XDMEvent.XDMSetEvent((Object) null, XUIEventInterface.DM_UIEVENT.XUI_DM_ABORT_BYUSER);
                                return;
                            case XEventInterface.XEVENT_ABORT_HTTP_ERROR /*242*/:
                                XDMEvent.XDMSetEvent((Object) null, XUIEventInterface.DM_UIEVENT.XUI_DM_HTTP_INTERNAL_ERROR);
                                return;
                    ...
                    XDMEvent.XDMSetEvent((Object) null, XUIEventInterface.DM_UIEVENT.XUI_DM_SYNC_ERROR);
                    return;
                ...
                case XEVENT_DM_TCPIP_OPEN:
                    ...
                    XDMMsg.xdmSendMessage(XEventInterface.XEVENT.XEVENT_DM_START, (Object) null, (Object) null);
                    return;
                case XEVENT_DL_CONNECT:
                    ...
                    if (xfotaDlTpInit == -7) {
                        ...
                        XDMMsg.xdmSendMessage(XEventInterface.XEVENT.XEVENT_DL_TCPIP_OPEN, (Object) null, (Object) null);
                        return;
                    }
                ...
                case XEVENT_DL_TCPIP_OPEN:
                    ...
                    if (i == 0) {
                        XDMMsg.xdmSendMessage(XEventInterface.XEVENT.XEVENT_DL_START, (Object) null, (Object) null);
                        return;
                    } else {
                        XDMMsg.xdmSendMessage(XEventInterface.XEVENT.XEVENT_DL_CONNECTFAIL, (Object) null, (Object) null);
                        return;
                ...
                case XEVENT_NOTI_RECEIVED:
                    ...
                    if (xnotiPushHdleMsgHandler == null) {
                        ...
                        if (i2 != 0) {
                            XDMMsg.xdmSendMessage(XEventInterface.XEVENT.XEVENT_NOTI_EXECUTE, xDBNotiInfo, (Object) null);
                            return;
                        }
                        return;
                    }
    ...
    private void checkDMRetry() throws InterruptedException {
        ...
        if (XDMDevinfAdapter.xdmBlocksDueToRoamingNetwork()) {
            ...
            XDMEvent.XDMSetEvent((Object) null, XUIEventInterface.DM_UIEVENT.XUI_DM_CONNECT_FAILED);
        }
        ...
        if (XDMDevinfAdapter.xdmBlocksDueToRoamingNetwork()) {
            ...
            if (xdbGetFUMOStatus != 230) {
                if (networkBlockType.isBlocked()) {
                    ...
                    XDMAgent.xdmAgentSetSyncMode(0);
                    XDMEvent.XDMSetEvent((Object) null, XUIEventInterface.DL_UIEVENT.XUI_DL_DOWNLOAD_RETRY_CONFIRM);
                } else {
