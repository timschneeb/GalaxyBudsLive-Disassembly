...
public class XDMSecReceiverApiCall {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            $SwitchMap$com$accessorydm$interfaces$XCommonInterface$INIT_TYPE[XCommonInterface.INIT_TYPE.INIT_TYPE_POLLING.ordinal()] = 1;
    ...
    public void showToastWithTitle(int i) {
        XDMToastHandler.xdmShowToast(String.format("%s%n%s", new Object[]{FotaProviderInitializer.getContext().getString(i), FotaProviderInitializer.getContext().getString(R.string.STR_COMMON_PLEASE_WAIT)}), 0);
    }
