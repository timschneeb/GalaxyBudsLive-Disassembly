...
public class XTPAdapter implements XDMDefInterface, XDMInterface, XTPInterface, XEventInterface, XFOTAInterface, XDBInterface {
    ...
    public int xtpReceivePackage(ByteArrayOutputStream byteArrayOutputStream, int i) {
        InputStream inputStream;
        int i2;
        Log.I("");
        HttpURLConnection uRLConnect = HttpNetworkInfo.getInstance().getURLConnect();
        if (uRLConnect == null) {
            Log.I("xtpReceivePackage URLConnect is null");
            return -2;
        }
        HttpURLConnectionAdapter httpURLConnectionAdapter = new HttpURLConnectionAdapter();
        this.networkTimer = new XTPNetworkTimer(i, XTPInterface.NetworkTimerMode.NETWORK_TIMER_MODE_RECEIVE);
        try {
            httpURLConnectionAdapter.httpUrlReceiveData(uRLConnect, g_HttpObj[i], this.networkTimer);
            int responseResultCode = getResponseResultCode(i);
            if (responseResultCode != 0) {
                Log.I("responseCode Fail : " + responseResultCode);
                try {
                    if (this.networkTimer != null) {
                        this.networkTimer.networkEndTimer();
                        this.networkTimer = null;
                    }
                } catch (Exception e) {
                    Log.E(e.toString());
            ...
            if (inputStream == null) {
                try {
                    Log.E("receiveInputStream is null");
                    if (inputStream != null) {
                        try {
                            inputStream.close();
                        } catch (Exception e2) {
                    ...
                    return -4;
                } catch (ExceptionHttpContent unused) {
                    if (inputStream != null) {
                        try {
                            inputStream.close();
                        } catch (Exception e3) {
                    ...
                    return -10;
                } catch (ExceptionHttpHeader | ExceptionHttpReceive unused2) {
                    if (inputStream != null) {
                        try {
                            inputStream.close();
                        } catch (Exception e4) {
                ...
                if (XDBFumoAdp.xdbGetFUMOStatus() != 30) {
                    httpUrlReceiveData(byteArrayOutputStream, i, httpURLConnectionAdapter, inputStream);
                    i2 = 0;
                } else {
                    i2 = httpUrlReceiveDeltaFile(httpURLConnectionAdapter, inputStream);
                }
                if (inputStream != null) {
                    try {
                        inputStream.close();
                ...
                Log.I("xtpReceivePackage Result : " + i2);
                return i2;
            }
        } catch (ExceptionHttpContent unused3) {
            inputStream = null;
            if (inputStream != null) {
            }
            if (this.networkTimer != null) {
            ...
            return -10;
        } catch (ExceptionHttpHeader | ExceptionHttpReceive unused4) {
            inputStream = null;
            if (inputStream != null) {
            }
            if (this.networkTimer != null) {
    ...
    private int httpUrlReceiveDeltaFile(HttpURLConnectionAdapter httpURLConnectionAdapter, InputStream inputStream) {
        ...
        if (!XDMCommonUtils.xdmGetTopActivityName().contains(XCommonInterface.PROGRESS_ACTIVITY_NAME)) {
            XDMMsg.xdmSendUIMessage(XUIEventInterface.DL_UIEVENT.XUI_DL_DOWNLOAD_IN_PROGRESS, (Object) null, (Object) null);
        }
        try {
            ...
            updateDownloadInfo.resetFlexibleBufferWithDownloadInfo();
            return 0;
        } catch (ExceptionStorageNotUsed e) {
            Log.E(e.toString());
            i = -8;
        } catch (ExceptionFileNotFound e2) {
            e = e2;
            Log.E(e.toString());
            i = -9;
        } catch (ExceptionFileIO e3) {
            e = e3;
            Log.E(e.toString());
            i = -9;
        } catch (Exception e4) {
