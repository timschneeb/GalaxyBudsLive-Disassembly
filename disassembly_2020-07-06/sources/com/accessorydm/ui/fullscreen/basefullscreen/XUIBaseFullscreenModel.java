...
public abstract class XUIBaseFullscreenModel {
    ...
    public String getFirmwareVersion() {
        ...
        return String.format(FotaProviderInitializer.getContext().getString(R.string.STR_ACCESSORY_UPDATE_VERSION), new Object[]{xdbGetUpdateFWVer});
    }

    public String getFirmwareSize() {
        return String.format(FotaProviderInitializer.getContext().getString(R.string.STR_ACCESSORY_UPDATE_SIZE_MB), new Object[]{String.format(Locale.getDefault(), "%.2f", new Object[]{Double.valueOf(((double) XDBFumoAdp.xdbGetObjectSizeFUMO()) / 1048576.0d)})});
    }
