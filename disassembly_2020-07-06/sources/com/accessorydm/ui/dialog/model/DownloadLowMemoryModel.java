...
public final class DownloadLowMemoryModel extends XUIDialogModel.Base {
    ...
    private static String message() {
        String format = String.format(Locale.getDefault(), "%d", new Object[]{Long.valueOf((long) Math.ceil(((double) (XDBFumoAdp.xdbGetObjectSizeFUMO() * 2)) / 1048576.0d))});
        return String.format(getString(HostDeviceTextType.get().getDownloadFailedLowMemoryMessageId()), new Object[]{format});
    }
