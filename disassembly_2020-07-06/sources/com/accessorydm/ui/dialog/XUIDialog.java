...
import com.accessorydm.ui.dialog.model.AccessorySysscopeScanningModel;
...
public enum XUIDialog {
    NONE {
        ...
        public XUIDialogModel getDialogModel() {
            ...
            return new XUIDialogModel.StubOk((String) null, (String) null);
        }
    },
    DL_MEMORY_FULL {
        /* access modifiers changed from: package-private */
    ...
    DM_ACCESSORY_SYSSCOPE_SCANNING {
        /* access modifiers changed from: package-private */
        public XUIDialogModel getDialogModel() {
            return new AccessorySysscopeScanningModel();
        }
    },
    ...
    DM_ACCESSORY_CONNECTION_FAILED {
        /* access modifiers changed from: package-private */
        public XUIDialogModel getDialogModel() {
            return new XUIDialogModel.StubOk((String) null, getString(DeviceType.get().getTextType().getConnectionFailedMessageId()));
        }
    },
    DM_ACCESSORY_LOW_BATTERY_WATCH {
        /* access modifiers changed from: package-private */
        public XUIDialogModel getDialogModel() {
            return new XUIDialogModel.StubOk(getString(R.string.STR_ACCESSORY_LOW_BATTERY_TITLE), String.format(getString(DeviceType.get().getTextType().getCopyAccessoryLowBatteryMessageId()), new Object[]{Integer.valueOf(AccessoryController.getInstance().getAccessoryUtil().getMinimumBatteryLevel())}));
        }
    },
    ...
    DM_ACCESSORY_INSTALL_FAILED {
        /* access modifiers changed from: package-private */
        public XUIDialogModel getDialogModel() {
            return new XUIDialogModel.StubOk((String) null, getString(R.string.STR_ACCESSORY_UPDATE_FAILED_TRY_LATER));
        }
    },
    ...
    private static final XUIDialog[] values = null;
