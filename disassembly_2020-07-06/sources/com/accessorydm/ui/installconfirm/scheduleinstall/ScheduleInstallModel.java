...
public class ScheduleInstallModel {
    ...
    public String getSetTimeToastText() {
        ...
        return String.format(FotaProviderInitializer.getContext().getString(R.string.STR_ACCESSORY_INSTALL_CONFIRM_SCHEDULED_TIMEPICKER_SET_TIME_TOAST_TEXT), new Object[]{format2, format});
    }
}
