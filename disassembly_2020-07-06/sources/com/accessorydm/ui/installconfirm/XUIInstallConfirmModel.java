...
public class XUIInstallConfirmModel extends XUIBaseFullscreenModel {
    ...
    public String getGuideText() {
        ...
        return String.format(FotaProviderInitializer.getContext().getString(R.string.STR_ACCESSORY_INSTALL_CONFIRM_SCHEDULED), new Object[]{format2, format});
    }
    ...
    public String getCautionText() {
        ...
        if (cautionSettingsTextId != -1) {
            string = string + 10 + FotaProviderInitializer.getContext().getString(cautionSettingsTextId);
        }
        if (cautionBackupTextId == -1) {
            return string;
        }
        return string + 10 + FotaProviderInitializer.getContext().getString(cautionBackupTextId);
    }
