...
public class XUILastUpdateModel extends XUIBaseFullscreenModel {
    ...
    public String getGuideText() {
        ...
        return String.format(FotaProviderInitializer.getContext().getString(R.string.STR_ACCESSORY_LAST_UPDATE_DAY_TIME), new Object[]{format, format2});
    }
    ...
    public String getFirmwareVersion() {
        ...
        return String.format(FotaProviderInitializer.getContext().getString(R.string.STR_ACCESSORY_UPDATE_VERSION), new Object[]{this.lastUpdateVersion});
    }
    ...
    public String getFirmwareSize() {
        ...
        return String.format(FotaProviderInitializer.getContext().getString(R.string.STR_ACCESSORY_UPDATE_SIZE_MB), new Object[]{String.format(Locale.getDefault(), "%.2f", new Object[]{Double.valueOf(((double) j) / 1048576.0d)})});
    }
