...
public class XDMDDFXmlHandler implements XDMInterface, XDMXml, XDMWbxml {
    ...
    public static boolean xdmDDFCreateNodeToOM(XDM_DDFXmlElement xDM_DDFXmlElement) {
        int i;
        String str;
        XDM_DDFXmlElement xDM_DDFXmlElement2 = xDM_DDFXmlElement;
        int i2 = xDM_DDFXmlElement2.scope;
        int i3 = xDM_DDFXmlElement2.format;
        int i4 = xDM_DDFXmlElement2.acl;
        String str2 = xDM_DDFXmlElement2.m_szData;
        if (TextUtils.isEmpty(xDM_DDFXmlElement2.m_szName)) {
            Log.E("Not exist nodename.");
            return false;
        }
        if (!(!TextUtils.isEmpty(XDMMem.xdmLibStrstr(xDM_DDFXmlElement2.m_szPath, XDMInterface.XDM_BASE_PATH)))) {
            if (!TextUtils.isEmpty(xDM_DDFXmlElement2.m_szPath)) {
                String concat = "".concat(XDMInterface.XDM_BASE_PATH).concat(xDM_DDFXmlElement2.m_szPath);
                xDM_DDFXmlElement2.m_szPath = null;
                xDM_DDFXmlElement2.m_szPath = concat;
            } else {
                xDM_DDFXmlElement2.m_szPath = XDMInterface.XDM_BASE_PATH;
            }
        }
        XDMAgent.xdmAgentSetXNodePath(xDM_DDFXmlElement2.m_szPath, xDM_DDFXmlElement2.m_szName, true);
        if (xDM_DDFXmlElement2.m_szName.equals("AAuthData")) {
            i3 = 1;
        }
        String concat2 = xDM_DDFXmlElement2.m_szPath.concat("/").concat(xDM_DDFXmlElement2.m_szName);
        if (i4 == 0) {
            i4 = 27;
        }
        if (i2 == 0) {
        ...
        if (i3 == 6 || i3 == 7 || i3 == 12) {
            xdmDDFSetOMTree(g_om, concat2, str2, 0, xDM_DDFXmlElement2.m_szType, i4, i2, i3);
            OMSETPATH(g_om, concat2, i4, i2);
        } else {
            if (i3 == 2) {
                str = str2;
                i = 0;
                ...
                if (TextUtils.isEmpty(str2)) {
                    str2 = "null";
                    xDM_DDFXmlElement2.m_szData = str2;
                }
                i = str2.length();
                str = str2;
            }
            ...
            xdmDDFSetOMTree(g_om, concat2, str, i, xDM_DDFXmlElement2.m_szType, i4, i2, i3);
        }
        return true;
    }
    ...
    public static String xdmDDFParseCDATA(String str) {
        ...
        if (!TextUtils.isEmpty(str) && XDMMem.xdmLibStrncmp(str, str3, str3.length()) == 0 && !TextUtils.isEmpty(XDMMem.xdmLibStrstr(str, str2)) && (indexOf = substring.indexOf(str2)) > 0) {
    ...
    public static void xdmDDFTNDSParsingFormatChildElement() {
        ...
        int xdmDDFTNDSGetXMLSize = xdmDDFTNDSGetXMLSize();
        int i = charAt + '@';
        if (!(i == 80 || i == 91 || i == 94 || i == 101 || i == 103 || i == 114)) {
            switch (i) {
                case 72:
                case 73:
                case 74:
        ...
        String str = "<".concat(xdmDDFTNDSGetTagString(i)).concat("/>");
    ...
    public static void xdmDDFProcessConvertStringData() {
        ...
        int xdmDDFTNDSGetXMLSize = xdmDDFTNDSGetXMLSize();
        String concat = xdmDDFTNDSGetWbxmlData.concat(String.valueOf(3));
        ...
        String concat2 = concat.concat(String.valueOf(0));
    ...
    public static void xdmDDFConvertAddTndsCodePage() {
        ...
        String xdmDDFTNDSGetWbxmlData = xdmDDFTNDSGetWbxmlData();
        int i = xdmDDFTNDSGetWbxmlSize - 1;
        String concat = xdmDDFTNDSGetWbxmlData.substring(0, i).concat(String.valueOf(0)).concat(String.valueOf(2)).concat(String.valueOf((char) xdmDDFTNDSGetWbxmlData.getBytes(Charset.defaultCharset())[i]));
