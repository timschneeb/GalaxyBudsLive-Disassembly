...
public class XDMParserDelete extends XDMHandleCmd implements XDMWbxml {
    public int cmdid;
    ...
    public int xdmParParseDelete(XDMParser xDMParser) {
        int xdmParParseCheckElement = xDMParser.xdmParParseCheckElement(16);
        ...
        do {
            ...
            if (i == 1) {
                ...
                xdmAgentHdlCmdDelete(xDMParser.userdata, this);
                return 0;
            } else if (i == 0) {
                xDMParser.xdmParParseReadElement();
                ...
                this.is_archive = xDMParser.xdmParParseBlankElement(i);
                continue;
            } else if (i == 11) {
                ...
                this.is_sftdel = xDMParser.xdmParParseBlankElement(i);
                continue;
            }
