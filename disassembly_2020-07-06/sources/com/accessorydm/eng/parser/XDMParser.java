...
public class XDMParser extends XDMWbxmlDecoder {
    ...
    public XDMList xdmParParseItemlist(XDMList xDMList) {
        ...
        while (true) {
            ...
            xDMList = XDMList.xdmListAppend(xDMList, (XDMList) null, this._pItem);
        }
    }
    ...
    public XDMList xdmParParseMapitemlist(XDMList xDMList) {
        ...
        while (true) {
            ...
            xDMList = XDMList.xdmListAppend(xDMList, (XDMList) null, this._pMapitem);
        }
    }
    ...
    public XDMList xdmParParseElelist(int i, XDMList xDMList) {
        ...
        while (true) {
            ...
            xDMList = XDMList.xdmListAppend((XDMList) null, (XDMList) null, this.m_szParserElement);
        }
    }
    ...
    public int xdmParParseCurrentElement() throws IOException {
        byte b = this.wbxbuff[this.wbxindex] & 255;
        if (b >= 0) {
            return b & 63 & Byte.MAX_VALUE;
        }
    ...
    public int xdmParParseZeroBitTagCheck() {
        ...
        byte b2 = b & 63 & Byte.MAX_VALUE;
        if (b2 < 5 || b2 > 60 || (b & MsgID.USAGE_REPORT) != 0) {
            i = 0;
        } else {
