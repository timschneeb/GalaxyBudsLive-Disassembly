...
public class XDMParserAdd extends XDMHandleCmd implements XDMWbxml {
    public int cmdid;
    ...
    public int xdmParParseAdd(XDMParser xDMParser) {
        ...
        do {
            ...
            if (i == 1) {
                ...
                xdmAgentHdlCmdAdd(xDMParser.userdata, this);
                return 0;
            } else if (i == 0) {
                xDMParser.xdmParParseReadElement();
