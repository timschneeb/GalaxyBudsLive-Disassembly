...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i, boolean z) {
        ...
        this.defaultMargin = resources.getDimensionPixelSize(R.dimen.material_bottom_navigation_margin);
        this.mHasIcon = z;
        if (this.mHasIcon) {
            LayoutInflater.from(context).inflate(R.layout.sesl_bottom_navigation_item, this, true);
            typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.BottomNavigationView, i, R.style.Widget_Material_BottomNavigationView);
        } else {
            LayoutInflater.from(context).inflate(R.layout.sesl_bottom_navigation_item_text, this, true);
            typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.BottomNavigationView, i, R.style.Widget_Material_BottomNavigationView_Text);
        }
        this.icon = (ImageView) findViewById(R.id.icon);
        this.smallLabel = (TextView) findViewById(R.id.smallLabel);
        this.largeLabel = (TextView) findViewById(R.id.largeLabel);
        this.mLargeLabelAppearance = typedArray.getResourceId(R.styleable.BottomNavigationView_bottomTextAppearance, 0);
        this.mSmallLabelAppearance = typedArray.getResourceId(R.styleable.BottomNavigationView_bottomTextAppearance, 0);
        typedArray.recycle();
    ...
    public void setShowButtonShape(int i, ColorStateList colorStateList) {
        if (Build.VERSION.SDK_INT > 27) {
            Drawable drawable = getResources().getDrawable(R.drawable.sesl_bottomnavigation_show_button_background);
        ...
        setBackground(getResources().getDrawable(R.drawable.sesl_bottom_navigation_show_background_o));
    }
