...
public class ShapeAppearancePathProvider {
    ...
    private void appendEdgePath(ShapeAppearancePathSpec shapeAppearancePathSpec, int i) {
        ...
        getEdgeTreatmentForIndex(i, shapeAppearancePathSpec.shapeAppearanceModel).getEdgePath((float) Math.hypot((double) (f - fArr2[0]), (double) (fArr[1] - fArr2[1])), edgeCenterForIndex, shapeAppearancePathSpec.interpolation, this.shapePath);
