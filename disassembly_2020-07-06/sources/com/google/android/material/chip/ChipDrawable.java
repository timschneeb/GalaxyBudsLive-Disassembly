...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback {
    ...
    private boolean onStateChange(int[] iArr, int[] iArr2) {
        ...
        int i = 0;
        int colorForState = colorStateList2 != null ? colorStateList2.getColorForState(iArr, this.currentChipSurfaceColor) : 0;
        ...
        int colorForState2 = colorStateList3 != null ? colorStateList3.getColorForState(iArr, this.currentChipBackgroundColor) : 0;
        ...
        int colorForState4 = colorStateList5 != null ? colorStateList5.getColorForState(iArr, this.currentCompatRippleColor) : 0;
        ...
        int colorForState5 = (textAppearance2 == null || textAppearance2.textColor == null) ? 0 : this.textAppearance.textColor.getColorForState(iArr, this.currentTextColor);
