...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, (AttributeSet) null, R.styleable.MaterialAlertDialog, DEF_STYLE_ATTR, DEF_STYLE_RES, new int[0]);
        this.backgroundInsetStart = obtainStyledAttributes.getDimensionPixelSize(R.styleable.MaterialAlertDialog_backgroundInsetStart, context2.getResources().getDimensionPixelSize(R.dimen.mtrl_alert_dialog_background_inset_start));
        this.backgroundInsetTop = obtainStyledAttributes.getDimensionPixelSize(R.styleable.MaterialAlertDialog_backgroundInsetTop, context2.getResources().getDimensionPixelSize(R.dimen.mtrl_alert_dialog_background_inset_top));
        this.backgroundInsetEnd = obtainStyledAttributes.getDimensionPixelSize(R.styleable.MaterialAlertDialog_backgroundInsetEnd, context2.getResources().getDimensionPixelSize(R.dimen.mtrl_alert_dialog_background_inset_end));
        this.backgroundInsetBottom = obtainStyledAttributes.getDimensionPixelSize(R.styleable.MaterialAlertDialog_backgroundInsetBottom, context2.getResources().getDimensionPixelSize(R.dimen.mtrl_alert_dialog_background_inset_bottom));
    ...
    public AlertDialog create() {
        ...
        if (ViewCompat.getLayoutDirection(decorView) == 0) {
        ...
        int i3 = i2;
        window.setBackgroundDrawable(new InsetDrawable(this.background, i3, this.backgroundInsetTop, i, this.backgroundInsetBottom));
        decorView.setOnTouchListener(new InsetDialogOnTouchListener(create, i2, this.backgroundInsetTop));
        return create;
    }
