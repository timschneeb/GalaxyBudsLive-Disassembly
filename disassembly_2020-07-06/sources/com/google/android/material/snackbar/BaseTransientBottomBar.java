...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private void startFadeInAnimation() {
        ...
        animatorSet.setInterpolator(AnimationUtils.loadInterpolator(this.context, 17563649));
    ...
    private void startFadeOutAnimation(final int i) {
        ...
        alphaAnimator.setInterpolator(AnimationUtils.loadInterpolator(this.context, 17563648));
