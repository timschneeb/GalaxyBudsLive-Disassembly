...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget {
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        super(ThemeEnforcement.createThemedContext(context, r7, r8, DEF_STYLE_RES), r7, r8);
        ...
        int i3 = i;
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.FloatingActionButton, i3, DEF_STYLE_RES, new int[0]);
        ...
        ShapeAppearanceModel shapeAppearanceModel2 = new ShapeAppearanceModel(context2, attributeSet, i3, DEF_STYLE_RES, -1);
