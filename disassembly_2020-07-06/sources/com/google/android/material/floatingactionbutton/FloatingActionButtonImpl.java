...
class FloatingActionButtonImpl {
    ...
    public void onPaddingUpdated(Rect rect) {
        if (shouldAddPadding()) {
            this.insetDrawable = new InsetDrawable(this.contentBackground, rect.left, rect.top, rect.right, rect.bottom);
    ...
    private abstract class ShadowAnimatorImpl extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            floatingActionButtonImpl.updateShadow((float) ((int) (f + ((this.shadowSizeEnd - f) * valueAnimator.getAnimatedFraction()))));
        }
