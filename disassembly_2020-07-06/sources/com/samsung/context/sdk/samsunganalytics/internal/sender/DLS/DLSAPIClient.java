...
public class DLSAPIClient implements AsyncTaskClient {
    ...
    private static final int MAX_TIMEOUT_IN_MILLISECONDS = 15000;
    ...
    private int getTimeout(int i) {
        ...
        return i > MAX_TIMEOUT_IN_MILLISECONDS ? MAX_TIMEOUT_IN_MILLISECONDS : i;
    }
    ...
    private String getBody() {
        ...
        while (it.hasNext()) {
            data = data + Delimiter.LOG_DELIMITER + ((SimpleLog) it.next()).getData();
        }
        return data;
    }
