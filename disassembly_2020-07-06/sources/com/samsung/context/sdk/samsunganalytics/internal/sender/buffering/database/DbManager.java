...
public class DbManager {
    ...
    public void insert(SimpleLog simpleLog) {
        ...
        writableDatabase.insert(TableInfo.TABLE_NAME, (String) null, contentValues);
    }

    public void delete(String str) {
        SQLiteDatabase writableDatabase = this.dbOpenHelper.getWritableDatabase();
        writableDatabase.delete(TableInfo.TABLE_NAME, "_id = " + str, (String[]) null);
    }

    public void delete(long j) {
        SQLiteDatabase writableDatabase = this.dbOpenHelper.getWritableDatabase();
        writableDatabase.delete(TableInfo.TABLE_NAME, "timestamp <= " + j, (String[]) null);
    }
