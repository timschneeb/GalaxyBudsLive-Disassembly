...
public class ServerTimePreference {
    ...
    public long getServerTime(Context context) {
        ...
        long longPreference = getLongPreference(context2, SERVER_TIME_SETTING, KEY_SETTING_TIME, 0);
        ...
        if (longPreference == 0) {
            ...
            return (System.currentTimeMillis() / 1000) + getLongPreference(context2, SERVER_TIME_SETTING, KEY_OFFSET, 0);
        }
    }
