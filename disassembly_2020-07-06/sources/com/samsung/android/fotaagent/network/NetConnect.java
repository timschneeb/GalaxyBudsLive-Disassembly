    ...
    public NetworkResult execute(Context context, NetworkAction networkAction) {
        ...
        if (!NetworkUtil.isWiFiNetworkConnected(context)) {
            if (NetworkUtil.isRoamingNetworkConnected(context)) {
                ...
                NetworkResult result = networkAction.getResult((RestResponse) null);
                ...
                NetworkResult result2 = networkAction.getResult((RestResponse) null);
        ...
        NetworkResult result3 = networkAction.getResult((RestResponse) null);
