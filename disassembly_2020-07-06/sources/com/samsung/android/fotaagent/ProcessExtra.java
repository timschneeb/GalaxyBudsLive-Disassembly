...
public class ProcessExtra {
    ...
    public void removeUI() {
        ...
        if (XDBFumoAdp.xdbGetFUMOStatus() <= 10) {
            ...
            XDMMsg.xdmSendMessage(XEventInterface.XEVENT.XEVENT_DM_ABORT, XDMMsg.xdmCreateAbortMessage(241, true), (Object) null);
        } else if (XUINotificationManager.getInstance().xuiGetNotificationType() != NotificationType.XUI_INDICATOR_DOWNLOAD_PROGRESS) {
