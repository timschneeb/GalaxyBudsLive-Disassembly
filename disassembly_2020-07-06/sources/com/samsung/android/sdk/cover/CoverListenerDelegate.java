...
class CoverListenerDelegate extends ICoverManagerCallback.Stub {
    ...
    public static final String TAG = ScoverManager.class.getSimpleName();
    ...
    private static class ListenerDelegateHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            ScoverManager.StateListener stateListener = (ScoverManager.StateListener) this.mListenerRef.get();
