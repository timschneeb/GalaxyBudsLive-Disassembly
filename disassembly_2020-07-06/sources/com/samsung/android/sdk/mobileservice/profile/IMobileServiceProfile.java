...
public interface IMobileServiceProfile extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMobileServiceProfile {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v2, resolved type: com.samsung.android.sdk.mobileservice.profile.Profile} */
            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case 3:
                        parcel.enforceInterface(DESCRIPTOR);
                        if (parcel.readInt() != 0) {
                            r0 = Profile.CREATOR.createFromParcel(parcel);
                        }
                        boolean requestProfileUpdate = requestProfileUpdate(r0, IProfileUpdateResultCallback.Stub.asInterface(parcel.readStrongBinder()));
                        parcel2.writeNoException();
                        parcel2.writeInt(requestProfileUpdate);
                        return true;
                    case 4:
                        parcel.enforceInterface(DESCRIPTOR);
                    ...
                    case 6:
                        ...
                        boolean requestPrivacyUpdate = requestPrivacyUpdate(r0, IPrivacyUpdateResultCallback.Stub.asInterface(parcel.readStrongBinder()));
                        parcel2.writeNoException();
                        parcel2.writeInt(requestPrivacyUpdate);
                        return true;
                    case 7:
                        parcel.enforceInterface(DESCRIPTOR);
                    ...
                    case 9:
                        ...
                        parcel2.writeNoException();
                        parcel2.writeInt(requestProfileBirthdayTypeUpdate);
                        return true;
                    default:
