...
public interface IMobileServiceAuth extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMobileServiceAuth {
            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case 14:
                        ...
                        parcel2.writeNoException();
                        parcel2.writeInt(isServiceRegistered);
                        return true;
                    case 15:
                        parcel.enforceInterface(DESCRIPTOR);
                    ...
                    case 28:
                        ...
                        parcel2.writeNoException();
                        parcel2.writeInt(disclaimerAgreementForSocial2);
                        return true;
                    default:
        ...
        private static class Proxy implements IMobileServiceAuth {
