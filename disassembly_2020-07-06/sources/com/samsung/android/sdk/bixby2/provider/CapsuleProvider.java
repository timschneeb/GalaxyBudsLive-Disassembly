...
public class CapsuleProvider extends ContentProvider {
    ...
    public static final String TAG = (CapsuleProvider.class.getSimpleName() + "_" + BuildConfig.VERSION_NAME);
     ...
     */
    private synchronized Bundle executeAction(String str, Bundle bundle) {
        try {
            ...
            if (bundle != null) {
                if (bundle.containsKey(ActionHandler.ACTION_TYPE)) {
                    CapsuleResponseCallback capsuleResponseCallback = new CapsuleResponseCallback();
                    final String str2 = str;
                    final Bundle bundle2 = bundle;
                    final CapsuleResponseCallback capsuleResponseCallback2 = capsuleResponseCallback;
                    Thread thread = new Thread(new Runnable() {
                        public void run() {
                            actionHandler.executeAction(CapsuleProvider.this.getContext(), str2, bundle2, capsuleResponseCallback2);
                        }
                    });
                    thread.start();
            ...
            String str3 = TAG;
            LogUtil.e(str3, "Unable to execute action." + e.toString());
            e.printStackTrace();
            ...
            synchronized (CapsuleProvider.this.sActionExecutionLock) {
                if (!this.actionTimedOut) {
                    if (!this.actionExecuted) {
                        ...
                        String access$200 = CapsuleProvider.TAG;
                        StringBuilder sb = new StringBuilder();
                        ...
                        sb.append(str);
                        LogUtil.d(access$200, sb.toString());
