...
public class LoggerFile extends Logger.Impl implements Logger.Core {
    private static final String[] priorities = {"H", "V", "D", "I", "W", "E", "F"};
    ...
    private String makeLogLine(String str, String str2) {
        return String.format(Locale.US, "%s [%s] [%5d %5d] %s\n", new Object[]{getDate(), str, Integer.valueOf(Process.myPid()), Integer.valueOf(Process.myTid()), new LogLineInfo().makeLogLine(str2)});
    }

    private static String getDate() {
        Calendar instance = Calendar.getInstance();
        return String.format(Locale.US, "%02d-%02d %02d:%02d:%02d.%03d", new Object[]{Integer.valueOf(instance.get(2) + 1), Integer.valueOf(instance.get(5)), Integer.valueOf(instance.get(11)), Integer.valueOf(instance.get(12)), Integer.valueOf(instance.get(13)), Integer.valueOf(instance.get(14))});
    }
}
