...
public class GeneralUtil {
    ...
    public static boolean isIdleScreen(ActivityManager activityManager) {
        Context context = FotaProviderInitializer.getContext();
        String topPackageName = getTopPackageName(activityManager);
        Log.I("top : " + topPackageName);
        return topPackageName.contains(context.getApplicationContext().getPackageName());
    }
        ...
        try {
            ...
            for (ActivityManager.RunningAppProcessInfo next : runningAppProcesses) {
                ...
                if (FotaProviderUtil.isSingleFotaProvider()) {
                    if ((i == 100 || i == 125 || i == 200 || i == 300 || i == 230 || i == 130) && next.processName.equals(FotaProviderUtil.getSingleFotaProviderPackageName())) {
    ...
    public static boolean isGSFPackagedInstalled(Context context) {
        if (context == null) {
        ...
        try {
            ...
            for (Signature equals : packageInfo.signatures) {
                if (GSF_SIGNATURES.equals(equals)) {
                    return true;
                }
            }
            return false;
