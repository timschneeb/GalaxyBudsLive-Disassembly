package com.samsung.accessory.neobeanmgr.common.preference;
...
public class Preferences {
    ...
    private static final String TAG = "NeoBean_Preferences";
    ...
    private static Object getObject(String str, Class cls, String str2) {
        ...
        if (sharedPreferences.contains(str)) {
            if (cls == String.class) {
                obj = sharedPreferences.getString(str, (String) null);
    ...
    public static void clearAll() {
        for (String clearSharedPreferences : Application.getContext().getSharedPreferences(NAME_PREFERENCE_LIST, 4).getAll().keySet()) {
    ...
    private static String getLastLaunchDeviceId() {
        return getString(PreferenceKey.LAST_LAUNCH_BT_ADDRESS, (String) null, MODE_MANAGER);
    }
