...
public class DottedLineView extends View {
    ...
    private static final String TAG = "NeoBean_DottedLineView";
    private int mColor;
    ...
    public void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        Log.d(TAG, "onDraw(" + getWidth() + ", " + getHeight() + ") " + String.format(Locale.US, "0x%x", new Object[]{Integer.valueOf(this.mColor)}));
