...
public class BluetoothUtil {
    ...
    public static String getAliasName(String str) {
        ...
        if (bondedDevice == null) {
            return Preferences.getString(PreferenceKey.LAST_BT_DEVICE_ALIAS_NAME, (String) null, str);
        }
        try {
    ...
    public static String getDeviceName(String str) {
        BluetoothDevice bondedDevice = getBondedDevice(str);
        if (bondedDevice == null) {
            return Preferences.getString(PreferenceKey.LAST_BT_DEVICE_NAME, (String) null, str);
        }
            ...
            if (bondedDevices != null) {
                for (BluetoothDevice next : bondedDevices) {
                    if (next.getAddress().equals(str)) {
                        try {
                            seccompat.android.bluetooth.BluetoothDevice.proxySetAlias(next, str2);
                        } catch (Error | Exception e) {
