package com.samsung.accessory.neobeanmgr.common.uhm;
...
public class UhmFwUtil {
    ...
    private static final String TAG = "NeoBean_UhmFwUtil";
    ...
    public static String getLastLaunchDeviceId() {
        return Preferences.getString(PreferenceKey.LAST_LAUNCH_BT_ADDRESS, (String) null, Preferences.MODE_MANAGER);
    }
