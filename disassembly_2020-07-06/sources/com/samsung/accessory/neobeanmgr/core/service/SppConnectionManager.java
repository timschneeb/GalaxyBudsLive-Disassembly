...
public class SppConnectionManager {
    ...
    private static final String TAG = "NeoBean_SppConnectionManager";
    /* access modifiers changed from: private */
    ...
    public synchronized void connect(final BluetoothDevice bluetoothDevice) {
        ...
        this.mWorkerHandler.post(new WorkerTask() {
            public void execute() {
                ...
                try {
                    BluetoothDevice unused = SppConnectionManager.this.mDevice = bluetoothDevice;
                    SppConnectionManager.this.setState(1);
                    Log.d(this.TAG, "connect() : connectSocket()");
                    BluetoothSocket unused2 = SppConnectionManager.this.mSocket = SppConnectionManager.this.mDevice.createInsecureRfcommSocketToServiceRecord(SppConnectionManager.STANDARD_SPP_UUID);
                    ...
                    InputStream unused3 = SppConnectionManager.this.mRecvStream = SppConnectionManager.this.mSocket.getInputStream();
                    OutputStream unused4 = SppConnectionManager.this.mSendStream = SppConnectionManager.this.mSocket.getOutputStream();
    ...
    /* access modifiers changed from: private */
    public synchronized void onSendBuffer(byte[] bArr) {
        try {
    ...
    class SppRecvThread extends Thread {
        private static final String TAG = "NeoBean_SppRecvThread";
        ...
        private void parseFrameBuffer() {
            ...
            while (true) {
                if ((this.mRecvBuffer.peek() == null || this.mRecvBuffer.peek().byteValue() != -3) && this.mRecvBuffer.peek() != null) {
                    Log.e(TAG, "lost=" + String.format(ByteUtil.HEX_FORMAT, new Object[]{this.mRecvBuffer.poll()}));
                    ...
                    if (this.mRecvBuffer.get(payloadLength - 1).byteValue() == -35) {
                        ...
                        Log.e(TAG, "lost2=" + String.format(ByteUtil.HEX_FORMAT, new Object[]{this.mRecvBuffer.poll()}));
                    }
                }
            }
        }
    ...
    static class CallbackHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            SppConnectionManager sppConnectionManager = (SppConnectionManager) this.mWeakSppConnection.get();
