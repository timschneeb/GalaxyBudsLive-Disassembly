...
import com.samsung.accessory.neobeanmgr.common.util.CRC16;
...
public class Msg {
    ...
    private static final String TAG = "NeoBean_Msg";
    ...
    public Msg(byte[] bArr) {
        ...
        Log.v(TAG, "MsgPopcorn(" + String.format(ByteUtil.HEX_FORMAT, new Object[]{Byte.valueOf(this.id)}) + ") : " + this.fragment + ":" + this.typeRes + ":" + this.payloadLength);
    }
                        ...
                        switch (b) {
                            ...
                            default:
                                switch (b) {
                                    ...
                                    default:
                                        Log.e(TAG, "createMsg() : return null (" + String.format(ByteUtil.HEX_FORMAT, new Object[]{Byte.valueOf(bArr[3])}) + ")");
                                        return null;
                                }
                        }
                }
