...
public class MsgStatusUpdated extends Msg {
    ...
    private static final String TAG = "NeoBean_MsgStatusUpdated";
    ...
    MsgStatusUpdated(byte[] bArr) {
        ...
        Log.d(TAG, "revision=" + this.revision + ", batteryLeft=" + this.batteryLeft + ", batteryRight=" + this.batteryRight + ", batteryCase=" + this.batteryCase);
    }
