...
import com.samsung.accessory.neobeanmgr.core.notification.NotificationTTSCore;
...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    private static final String TAG = "NeoBean_AlarmReceiver";
    ...
    private NotificationMessage getAlarmMessage(Context context, int i) {
        ...
        try {
            ...
            if (!(contentResolver == null || parse == null)) {
                Cursor query = contentResolver.query(parse, (String[]) null, "_id = " + i, (String[]) null, "alerttime ASC");
                if (query == null) {
                    return null;
                }
                if (query.moveToFirst() && query.getCount() > 0) {
                    ...
                    if (string != null && i2 > 0) {
                        ...
                        NotificationMessage notificationMessage = new NotificationMessage(NotificationMessage.TYPE_ALARM, NotificationConstants.ALARM_PACKAGENAME, getApplicationLabel(context), (String) null, string, (long) i2);
    ...
    private NotificationMessage makeAlarmMessage(Context context) {
        ...
        return new NotificationMessage(NotificationMessage.TYPE_ALARM, NotificationConstants.ALARM_PACKAGENAME, getApplicationLabel(context), (String) null, (String) null, (long) parseInt);
    }
        ...
        if (NotificationUtil.semAreNotificationsEnabledForPackage(NotificationConstants.ALARM_PACKAGENAME, false, 0)) {
            if (action.equals("com.samsung.sec.android.clockpackage.alarm.ALARM_STOPPED_IN_ALERT")) {
                ...
                if (alarmMessage != null && preAlarmID != intExtra) {
                    ...
                    context.sendBroadcast(intent2, "com.samsung.accessory.neobeanmgr.permission.SIGNATURE");
                }
            }
        }
    }
