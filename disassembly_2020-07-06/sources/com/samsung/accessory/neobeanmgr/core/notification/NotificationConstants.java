...
public class NotificationConstants {
    ...
    public static final String ACTION_CHANGE_TTS = "com.samsung.accessory.neobean.ACTION_CHANGE_TTS";
    public static final String ACTION_NOTIFICATION_LIST_UPDATE = "android.intent.neobean.action.NOTIFICATION_LIST_UPDATE";
    public static final String ACTION_NOTIFICATION_SETTING_UPDATE = "android.intent.neobean.action.NOTIFICATION_SETTTING_UPDATE";
    public static final String ACTION_UPDATE_VN_MESSAGE = "com.samsung.accessory.neobean.service.UPDATE_VN_EVENT";
