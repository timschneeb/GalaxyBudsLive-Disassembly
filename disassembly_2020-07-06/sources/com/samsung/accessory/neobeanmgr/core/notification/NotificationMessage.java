...
public class NotificationMessage implements Serializable {
    private static final String TAG = "NeoBean_NotificationMessage";
    ...
    public void log() {
        Log.d(TAG, "type : 0x" + String.format("%x ", new Object[]{Integer.valueOf(this.type)}) + ", pkgName : " + this.pkgName + ", appName : " + this.appName + ", when : " + this.when);
    }
}
