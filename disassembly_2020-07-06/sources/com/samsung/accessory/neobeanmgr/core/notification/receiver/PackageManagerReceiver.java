...
public class PackageManagerReceiver extends BroadcastReceiver {
    ...
    private static final String TAG = "NeoBean_PackageManagerReceiver";
            ...
            while (i2 < length) {
                ...
                if (userProfiles != null) {
                    ...
                    if (userHandle != null) {
                        ...
                        registerReceiverForKnox(context, packageManagerReceiver, userHandle, intentFilter, (String) null, (Handler) null);
    ...
    private static void registerReceiverForKnox(Context context, BroadcastReceiver broadcastReceiver, UserHandle userHandle, IntentFilter intentFilter, String str, Handler handler) {
        ...
        try {
            context.getClass().getMethod("registerReceiverAsUser", new Class[]{BroadcastReceiver.class, UserHandle.class, IntentFilter.class, String.class, Handler.class}).invoke(context, new Object[]{broadcastReceiver, userHandle, intentFilter, str, handler});
