...
public class NotificationTTSCore {
    ...
    private static final String TAG = "NeoBean_NotificationTTSCore";
    ...
    private TextToSpeech.OnInitListener initAlarmTTSListener = new TextToSpeech.OnInitListener() {
        public void onInit(int i) {
            if (i == 0) {
                if (Preferences.getString(PreferenceKey.NOTIFICATION_LANGUAGE, (String) null) == null && NotificationTTSCore.this.mTTS != null) {
    ...
    /* access modifiers changed from: private */
    public NotificationSpeakListener mSpeakCallBack = null;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public void speakAlarm(NotificationMessage notificationMessage) {
    ...
    /* access modifiers changed from: private */
    public void speakCall(NotificationMessage notificationMessage) {
            ...
            textToSpeech.setOnUtteranceProgressListener(new UtteranceProgressListener() {
                ...
                public void onStart(String str) {
                    ...
                    if (NotificationTTSCore.this.mNeedRingtoneMute == null) {
                        Bundle unused = NotificationTTSCore.this.mNeedRingtoneMute = new Bundle();
                    }
