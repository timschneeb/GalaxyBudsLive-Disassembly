...
import com.samsung.accessory.neobeanmgr.common.util.ActionBuffer;
...
public class GameModeManager {
    ...
    private static final String TAG = "NeoBean_GameModeManager";
    ...
    private final ServiceConnection CONNECTION_LISTENER = new ServiceConnection() {
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            boolean z = true;
            boolean unused = GameModeManager.this.mBound = true;
            ...
            try {
                ...
                boolean unused2 = gameModeManager.mSucceedToSubscribe = z;
        ...
        public void onServiceDisconnected(ComponentName componentName) {
            ...
            boolean unused = GameModeManager.this.mBound = false;
        }
    };
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction() != null) {
                ...
                switch (c) {
                    case 0:
                        Byte unused = GameModeManager.this.mLastGameModeValue = null;
                        GameModeManager.this.onExtendedStatusReady();
                        return;
                    case 1:
                        Byte unused2 = GameModeManager.this.mLastGameModeValue = null;
                        return;
                    case 2:
    ...
    /* access modifiers changed from: private */
    public void onGameModeChanged(String str, boolean z) {
    ...
    /* access modifiers changed from: private */
    public void onInUserUseChanged(boolean z) {
    ...
    /* access modifiers changed from: private */
    public void onMaxBufferCondition() {
    ...
    private void sendSppMessage(boolean z, boolean z2) {
        if (this.mSupportService.isConnected()) {
            byte b = z2 | (z ? (char) 16 : 0) ? (byte) 1 : 0;
    ...
    private void registerReceiver() {
        Application.getContext().registerReceiver(this.mGosReceiver, getGosIntentFilter(), "android.permission.WRITE_SECURE_SETTINGS", (Handler) null);
