...
import com.samsung.accessory.neobeanmgr.core.fmm.base.FmmBaseModel;
...
import com.samsung.accessory.neobeanmgr.core.fmm.utils.FmmUtils;

public class FmmModels {
    /* access modifiers changed from: private */
    public static final String TAG = (Application.TAG_ + FmmModels.class.getSimpleName());
    /* access modifiers changed from: private */
    public static FmmConfig mFmmConfigValue;
    ...
    public static class DeviceInfoModel extends FmmBaseModel {
        ...
        public JsonObject makeJsonData() {
            ...
            jsonObject.addProperty("battery", (Number) Integer.valueOf(FmmUtils.getLeftBattery()));
            jsonObject.addProperty("status", (Number) Integer.valueOf(FmmUtils.getLeftDeviceStatus()));
            ...
            jsonObject2.addProperty("battery", (Number) Integer.valueOf(FmmUtils.getRightBattery()));
            jsonObject2.addProperty("status", (Number) Integer.valueOf(FmmUtils.getRightDeviceStatus()));
            ...
            jsonObject4.addProperty("model_name", "Galaxy Buds Live");
            jsonObject4.addProperty("nickname", FmmUtils.getNickName(this.mUid));
            jsonObject4.addProperty("model_number", FmmConstants.MODEL_NUMBER);
    ...
    public static class SetDeviceInfoModel extends FmmBaseModel {
        ...
        private void init() {
            this.resultCodeLeft = FmmUtils.getLeftIsConnected().booleanValue() ^ true ? 1 : 0;
            this.resultCodeRight = FmmUtils.getRightIsConnected().booleanValue() ^ true ? 1 : 0;
        }
        ...
        public JsonObject makeJsonData() {
            ...
            jsonObject.addProperty("result_code", (Number) Integer.valueOf(this.resultCodeLeft));
            JsonObject jsonObject2 = new JsonObject();
            if (this.resultCodeRight != 0) {
                str = FmmConstants.Result.FAIL;
            }
            jsonObject2.addProperty("result", str);
            jsonObject2.addProperty("result_code", (Number) Integer.valueOf(this.resultCodeRight));
            JsonObject jsonObject3 = new JsonObject();
            jsonObject3.add("left", jsonObject);
            jsonObject3.add("right", jsonObject2);
            JsonObject jsonObject4 = new JsonObject();
    ...
    public static class getDeviceInfoModel extends FmmBaseModel {
        ...
        public JsonObject makeJsonData() {
            ...
            jsonObject.addProperty(FmmConstants.fmmConfig.maxN, (Number) Integer.valueOf(FmmConfig.left_maxN));
            FmmConfig unused8 = FmmModels.mFmmConfigValue;
            jsonObject.addProperty("region", (Number) Integer.valueOf(FmmConfig.left_region));
            JsonObject jsonObject2 = new JsonObject();
            ...
            jsonObject2.addProperty(FmmConstants.fmmConfig.maxN, (Number) Integer.valueOf(FmmConfig.right_maxN));
            FmmConfig unused16 = FmmModels.mFmmConfigValue;
            jsonObject2.addProperty("region", (Number) Integer.valueOf(FmmConfig.right_region));
            JsonObject jsonObject3 = new JsonObject();
            ...
            jsonObject3.addProperty("battery", (Number) Integer.valueOf(FmmUtils.getLeftBattery()));
            jsonObject3.addProperty("status", (Number) Integer.valueOf(FmmUtils.getLeftDeviceStatus()));
            ...
            jsonObject4.addProperty("battery", (Number) Integer.valueOf(FmmUtils.getRightBattery()));
            jsonObject4.addProperty("status", (Number) Integer.valueOf(FmmUtils.getRightDeviceStatus()));
            ...
            jsonObject6.addProperty("model_name", "Galaxy Buds Live");
            jsonObject6.addProperty("nickname", FmmUtils.getNickName(this.mUid));
            jsonObject6.addProperty("model_number", FmmConstants.MODEL_NUMBER);
