...
public class NotificationListAdapter extends RecyclerView.Adapter<RecyclerViewHolder> implements Filterable {
    ...
    public ArrayList<NotificationAppData> mAppList;
    private Context mContext;
    /* access modifiers changed from: private */
    public ICheckedNotificationApp mListener;
    /* access modifiers changed from: private */
    public String mSearchText;
    /* access modifiers changed from: private */
    public ArrayList<NotificationAppData> originalAppList;
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            public void publishResults(CharSequence charSequence, Filter.FilterResults filterResults) {
                ArrayList unused = NotificationListAdapter.this.mAppList = (ArrayList) filterResults.values;
                String unused2 = NotificationListAdapter.this.mSearchText = charSequence.toString();
