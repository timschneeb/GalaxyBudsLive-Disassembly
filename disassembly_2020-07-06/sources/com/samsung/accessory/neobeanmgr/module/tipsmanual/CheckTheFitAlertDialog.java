...
public class CheckTheFitAlertDialog extends AlertDialog {
    ...
    public final String TAG = (Application.TAG_ + CheckTheFitAlertDialog.class.getSimpleName());
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public ProgressBar mCheckFitProgress;
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            char c;
            String access$000 = CheckTheFitAlertDialog.this.TAG;
            Log.d(access$000, "onReceive : " + intent.getAction() + ", currentPage : " + CheckTheFitAlertDialog.this.currentPage);
            ...
            if (c == 0) {
                int access$200 = CheckTheFitAlertDialog.this.currentPage;
                if (access$200 == 0) {
                    CheckTheFitAlertDialog.this.updateWearingUI();
                } else if (access$200 == 1 && !CheckTheFitAlertDialog.this.isWearingBothEarbuds()) {
                    CheckTheFitAlertDialog.this.setPage(0);
                }
            } else if (c == 1) {
                CheckTheFitAlertDialog.this.dismiss();
            } else if (c == 2) {
                CheckTheFitAlertDialog.this.timeOutHandler.removeCallbacksAndMessages((Object) null);
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.alert_dialog_tips_check_the_fit);
    ...
    /* access modifiers changed from: private */
    public void startFitCheck() {
        this.valueAnimator = ValueAnimator.ofInt(new int[]{0, this.mCheckFitProgress.getMax()});
    ...
    /* access modifiers changed from: private */
    public void sendCheckFitSppMessage(boolean z) {
        String str = this.TAG;
    ...
    public void updateWearingUI() {
        ...
        String str = this.TAG;
        Log.d(str, "updateWearingUI() isConnected : " + isConnected + ", isLeftWearing : " + z2 + ", isRightWearing : " + z3);
    }
    ...
    /* access modifiers changed from: private */
    public boolean isWearingBothEarbuds() {
