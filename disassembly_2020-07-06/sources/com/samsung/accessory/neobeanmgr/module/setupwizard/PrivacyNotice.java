...
public class PrivacyNotice {
    ...
    private static final String TAG = "NeoBean_PrivacyNotice";
    ...
    static {
        ...
        MAP_GLOBAL_LANGUAGE_TO_FILENAME.put(GroupMemberContract.GroupMember.ID, "[Global] Galaxy Wearable Privacy Notice_Global_191229_Indonesian.txt");
        ...
        if (Application.DEBUG_MODE) {
            ...
            if (hashSet != null) {
                int i = 0;
                for (Map map : new Map[]{MAP_GDPR_LANGUAGE_TO_FILENAME, MAP_GLOBAL_LANGUAGE_TO_FILENAME, MAP_US_LANGUAGE_TO_FILENAME}) {
    ...
    public static String getString() {
        ...
        if (Util.isGDPRCountry(countryIso)) {
