...
import com.samsung.accessory.neobeanmgr.common.ui.DialRotationView;
...
public class CardEqualizer extends Card implements DialRotationView.DialEventListener {
    private static final String TAG = "NeoBean_CardEqualizer";
    ...
    public void updateUI() {
        ...
        if (this.mItemViewHolder != null) {
            ...
            if (coreService == null || !coreService.isConnected()) {
                ...
                UiUtil.setDimColorFilter(this.mItemViewHolder.mEqualizerIcon);
            ...
            this.mItemViewHolder.mEqualizerIcon.clearColorFilter();
        ...
        if (i != 0) {
            ...
            if (i != 1) {
                ...
                if (i == 2) {
                    ...
                    this.mItemViewHolder.itemView.setContentDescription(Application.getContext().getString(R.string.equalizer_content_description, new Object[]{Application.getContext().getString(R.string.eq_preset_soft)}));
                } else if (i == 3) {
                    ...
                    this.mItemViewHolder.itemView.setContentDescription(Application.getContext().getString(R.string.equalizer_content_description, new Object[]{Application.getContext().getString(R.string.eq_preset_dynamic)}));
                } else if (i == 4) {
                    ...
                    this.mItemViewHolder.itemView.setContentDescription(Application.getContext().getString(R.string.equalizer_content_description, new Object[]{Application.getContext().getString(R.string.eq_preset_clear)}));
                } else if (i == 5) {
                    ...
                    this.mItemViewHolder.itemView.setContentDescription(Application.getContext().getString(R.string.equalizer_content_description, new Object[]{Application.getContext().getString(R.string.eq_preset_treble_boost)}));
                }
            } else {
                ...
                this.mItemViewHolder.itemView.setContentDescription(Application.getContext().getString(R.string.equalizer_content_description, new Object[]{Application.getContext().getString(R.string.eq_preset_bass_boost)}));
            }
        } else {
            ...
            this.mItemViewHolder.itemView.setContentDescription(Application.getContext().getString(R.string.equalizer_content_description, new Object[]{Application.getContext().getString(R.string.eq_preset_normal)}));
        }
    }
