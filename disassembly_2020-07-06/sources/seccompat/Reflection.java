...
public class Reflection {
    ...
    private static final String TAG = "NeoBean_Reflection";
    ...
    private static Class<?>[] createParameterTypes(Object... objArr) {
        Class<Character>[] clsArr = new Class[objArr.length];
    ...
    public static Object callStaticMethod(String str, String str2, Object... objArr) {
        try {
            return _callMethod((Object) null, Class.forName(str), str2, objArr);
    ...
    public static Object getStaticField(String str, String str2) {
        try {
            return _getField((Object) null, Class.forName(str), str2);
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
            throw new NoClassDefFoundError(str);
        }
